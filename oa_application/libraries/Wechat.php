 ...
 *  usage:
 *   $options = array(
 *			'token'=>'wind1748', //填写你设定的key
 *			'encodingaeskey'=>'encodingaeskey', //填写加密用的EncodingAESKey
 *			'appid'=>'wx4a38c903aa4b7e5f', //填写高级调用功能的app id
 *			'appsecret'=>'888c117080fc3629db1374b777d50a6b ' //填写高级调用功能的密钥
 *		);
...
class Wechat
{
	...
	const EVENT_KF_SEESION_SWITCH = 'Getservice';  //多客服 - 转接会话
